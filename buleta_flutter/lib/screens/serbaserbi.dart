...
import 'package:buleta_flutter/services/serbaserbipost.dart';
import 'package:flutter/material.dart';

class Serba extends StatefulWidget {
  Serba({Key? key}) : super(key: key);

  @override
  State<Serba> createState() => _SerbaState();
}

class _SerbaState extends State<Serba> {
  SerbaPost postService = SerbaPost();
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: Text('Serba Serbi'),
